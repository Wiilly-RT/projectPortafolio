...
def main(page: ft.Page):
    ...
    def mostrar_portafolio():
        ...
        portafolio_container = ft.Container(
            ft.Column([
                ft.Row([home_button, logout_button], alignment=ft.MainAxisAlignment.SPACE_BETWEEN),
                ft.Container(
                    img_container,
        ...
        page.add(portafolio_container,img_container)
        page.bgcolor = ft.colors.BLACK
        page.update()
